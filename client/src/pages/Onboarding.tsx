            ...
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="space-y-8 max-w-lg">
                ...
                <Slider
                  ...
                  onChange={(v) =>
                    updateField("dailyCalorieIntake", v)
                  }
                  unit="kcal"
                ...
                <Slider
                  ...
                  onChange={(v) =>
                    updateField("dailyCalorieBurn", v)
                  }
                  unit="kcal"
          ...
          <div className="flex gap-3 lg:justify-end">
            {step > 1 && (
              <Button
                ...
                className="mx-lg:flex-1 lg:px-10"
              >
            ...
            <Button onClick={handleNext} className="mx-lg:flex-1 lg:px-10">
              <span className="flex items-center gap-2">
